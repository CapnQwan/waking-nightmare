import { getFragmentShader, getVertexShader } from "@/helpers/WebGL/WebGLShadersHelper";
...
export class Shader {
    ...
    constructor({vertexShader, fragmentShader }: shaderConstructor) {
        ...
        this._fragmentShader = fragmentShader ?? getFragmentShader(defaultFragmentShader);
